...
// --- Battle Factory Tier Select ---
static const u8 sText_BF_Tier_OU[]    = _("OU");
static const u8 sText_BF_Tier_UU[]    = _("UU");
static const u8 sText_BF_Tier_RU[]    = _("RU");
static const u8 sText_BF_Tier_NU[]    = _("NU");
static const u8 sText_BF_Tier_PU[]    = _("PU");
static const u8 sText_BF_Tier_UBERS[] = _("Ubers");

static const struct MenuAction MultichoiceList_BattleFactoryTiers[] = {
    { sText_BF_Tier_OU },
    { sText_BF_Tier_UU },
    { sText_BF_Tier_RU },
    { sText_BF_Tier_NU },
...
static const u8 sText_BF_Forms_On[]  = _("Mega/Gmax ON");
static const u8 sText_BF_Forms_Off[] = _("Mega/Gmax OFF");

static const struct MenuAction MultichoiceList_BattleFactoryForms[] = {
    { sText_BF_Forms_On },
    { sText_BF_Forms_Off },
};

// --- Dynamic Weather Debug ---
static const u8 sText_Weather_Auto[]      = _("Auto");
static const u8 sText_Weather_Clear[]     = _("Despejado");
static const u8 sText_Weather_Sunny[]     = _("Soleado");
static const u8 sText_Weather_Cloudy[]    = _("Nublado");
static const u8 sText_Weather_Rain[]      = _("Lluvia");
static const u8 sText_Weather_Storm[]     = _("Tormenta");
static const u8 sText_Weather_Fog[]       = _("Niebla");
static const u8 sText_Weather_Sand[]      = _("Arena");
static const u8 sText_Weather_Snow[]      = _("Nieve");
static const u8 sText_Weather_Exit[]      = _("Salir");

static const struct MenuAction MultichoiceList_DynamicWeather[] = {
    { sText_Weather_Auto },
    { sText_Weather_Clear },
    { sText_Weather_Sunny },
    { sText_Weather_Cloudy },
    { sText_Weather_Rain },
    { sText_Weather_Storm },
    { sText_Weather_Fog },
    { sText_Weather_Sand },
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_BATTLE_FACTORY_TIERS]       = MULTICHOICE(MultichoiceList_BattleFactoryTiers),
    [MULTI_BATTLE_FACTORY_FORMS]       = MULTICHOICE(MultichoiceList_BattleFactoryForms),
    [MULTI_DYNAMIC_WEATHER]            = MULTICHOICE(MultichoiceList_DynamicWeather),
