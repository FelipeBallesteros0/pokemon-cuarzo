...
ALIGNED(4) static const u8 sText_CantTransmitTrainerTooFar[] = _("No puedes transmitir con un ENTRENADOR\nque está demasiado lejos.\p");
...
ALIGNED(4) static const u8 sText_CantTradeForPartnersMon[] = _("No puedes intercambiar el POKéMON\nde {STR_VAR_1} ahora mismo.\p");
