...
const struct Tileset gTileset_PokeballBuilding =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_PokeballBuilding,
    .palettes = gTilesetPalettes_PokeballBuilding,
    .metatiles = gMetatiles_PokeballBuilding,
    .metatileAttributes = gMetatileAttributes_PokeballBuilding,
};
