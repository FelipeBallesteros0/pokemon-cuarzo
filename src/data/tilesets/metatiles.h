...
const u16 gMetatiles_PokeballBuilding[] = INCBIN_U16("data/tilesets/secondary/pokeball_building/metatiles.bin");
const u16 gMetatileAttributes_PokeballBuilding[] = INCBIN_U16("data/tilesets/secondary/pokeball_building/metatile_attributes.bin");
