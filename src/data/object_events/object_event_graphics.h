...
// Custom: tall "high rock" for the Bounce field move (palette generated from the indexed PNG)
const u32 gObjectEventPic_HighBoulder[] = INCGFX_U32("graphics/object_events/pics/misc/high_boulder.png", ".4bpp");
const u16 gObjectEventPal_HighBoulder[] = INCGFX_U16("graphics/object_events/pics/misc/high_boulder.png", ".gbapal");
