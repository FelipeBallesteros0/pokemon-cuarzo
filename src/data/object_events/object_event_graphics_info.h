...
// Custom: tall "high rock" jumped over with the Bounce field move. Mirrors the
// PushableBoulder layout (static 16x16, inanimate) but with custom art + palette.
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_HighBoulder = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_HIGH_BOULDER,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 128,
    .width = 16,
    .height = 16,
