...
static const struct PartyMenuBoxInfoRects sPartyBoxInfoRects[] =
{
    ...
    [PARTY_BOX_EQUAL_COLUMN] =
    {
        ...
        {
            // x, y, width, height for nickname, level, gender, hp, maxhp, hp bar
            33,  2, 40, 13, // Nickname
             3, 25, 32,  8, // Level
           100,  1,  8,  8, // Gender
            48, 25, 24,  8, // HP
...
static const u8 sEqualMainSlotTileNums_Egg[] =
{
    43, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 45,
    49, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 50,
    49, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 50,
...
static const u8 sEqualEmptySlotTileNums[] =
{
...
static const u8 sText_Trade4[] = _("INTERCAMBIAR");
...
{
    [MENU_SUMMARY]         = {COMPOUND_STRING("RESUMEN"),         CursorCb_Summary},
    [MENU_SWITCH]          = {COMPOUND_STRING("CAMBIAR"),         CursorCb_Switch},
    [MENU_CANCEL1]         = {gText_Cancel2,                      CursorCb_Cancel1},
    [MENU_ITEM]            = {COMPOUND_STRING("OBJETO"),          CursorCb_Item},
    [MENU_GIVE]            = {gMenuText_Give,                     CursorCb_Give},
    [MENU_TAKE_ITEM]       = {COMPOUND_STRING("QUITAR"),          CursorCb_TakeItem},
    [MENU_MOVE_ITEM]       = {COMPOUND_STRING("MOVER"),           CursorCb_MoveItem},
    [MENU_MAIL]            = {COMPOUND_STRING("CORREO"),          CursorCb_Mail},
    [MENU_TAKE_MAIL]       = {COMPOUND_STRING("QUITAR"),          CursorCb_TakeMail},
    [MENU_READ]            = {COMPOUND_STRING("LEER"),            CursorCb_Read},
    [MENU_CANCEL2]         = {gText_Cancel2,                      CursorCb_Cancel2},
    [MENU_SHIFT]           = {COMPOUND_STRING("CAMBIAR"),         CursorCb_SendMon},
    [MENU_SEND_OUT]        = {COMPOUND_STRING("SACAR"),           CursorCb_SendMon},
    [MENU_ENTER]           = {COMPOUND_STRING("ENTRAR"),          CursorCb_Enter},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("NO ENTRAR"),       CursorCb_NoEntry},
    [MENU_STORE]           = {COMPOUND_STRING("GUARDAR"),         CursorCb_Store},
    [MENU_REGISTER]        = {gText_Register,                     CursorCb_Register},
    [MENU_TRADE1]          = {sText_Trade4,                       CursorCb_Trade1},
    [MENU_TRADE2]          = {sText_Trade4,                       CursorCb_Trade2},
    [MENU_TOSS]            = {gMenuText_Toss,                     CursorCb_Toss},
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("MOVS. NIVEL"),     CursorCb_ChangeLevelUpMoves},
	[MENU_EGG_MOVES]       = {COMPOUND_STRING("MOVS. HUEVO"),     CursorCb_ChangeEggMoves},
	[MENU_TM_MOVES]        = {COMPOUND_STRING("MOVS. MT"),        CursorCb_ChangeTMMoves},
	[MENU_TUTOR_MOVES]     = {COMPOUND_STRING("MOVS. TUTOR"),     CursorCb_ChangeTutorMoves},
    [MENU_SUB_MOVES]       = {COMPOUND_STRING("APRENDER MOVS."),  CursorCb_LearnMovesSubMenu},
    ...
    [MENU_CATALOG_FRIDGE]  = {COMPOUND_STRING("Frigorífico"),     CursorCb_CatalogFridge},
