...
{
    { // Slot 0 left
        .bg = 0, .tilemapLeft = 1,  .tilemapTop = 0,
        .width = 14, .height = 5, .paletteNum = 3, .baseBlock = 0x63,
    },
    { // Slot 1 right
        .bg = 0, .tilemapLeft = 15, .tilemapTop = 1,
        .width = 14, .height = 5, .paletteNum = 4, .baseBlock = 0xA9,
    },
    { // Slot 2 left
        .bg = 0, .tilemapLeft = 1,  .tilemapTop = 5,
        .width = 14, .height = 5, .paletteNum = 5, .baseBlock = 0xEF,
    },
    { // Slot 3 right
        .bg = 0, .tilemapLeft = 15, .tilemapTop = 6,
        .width = 14, .height = 5, .paletteNum = 6, .baseBlock = 0x135,
    },
    { // Slot 4 left
        .bg = 0, .tilemapLeft = 1,  .tilemapTop = 10,
        .width = 14, .height = 5, .paletteNum = 7, .baseBlock = 0x17B,
    },
    { // Slot 5 right
        .bg = 0, .tilemapLeft = 15, .tilemapTop = 11,
        .width = 14, .height = 5, .paletteNum = 8, .baseBlock = 0x1C1,
    },
    [WIN_MSG] = {
        .bg = 2, .tilemapLeft = 1, .tilemapTop = 15,
        .width = 28, .height = 4, .paletteNum = 14, .baseBlock = 0x21F,
    },
    DUMMY_WIN_TEMPLATE
};
...
// Equal-column layout: slot 5 occupies baseBlocks 0x1C1–0x206, so cancel must start at 0x207
