...
// GEN 9 ITEMS
    ...
    [ITEM_REPELENTE_RECARGABLE] =
    {
        .name = ITEM_NAME("Repel. Recargable"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Un repelente con\n"
            "depósito recargable.\n"
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_RechargeableRepel,
        .iconPic = gItemIcon_Repel,
        .iconPalette = gItemIconPalette_Repel,
    },

    [ITEM_CARGA_DE_REPELENTE] =
    {
        .name = ITEM_NAME("Carga de repelente"),
        .price = 300,
        .description = COMPOUND_STRING(
            "Recarga 100 pasos\n"
            "del Repelente\n"
        ...
        .sortType = ITEM_TYPE_FIELD_USE,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_RepelCharge,
        .iconPic = gItemIcon_Repel,
        .iconPalette = gItemIconPalette_Repel,
    },

    [ITEM_BICICLETA_ELECTRICA] =
    {
        .name = ITEM_NAME("Bicicleta eléctrica"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Una bicicleta más\n"
            "rápida que la\n"
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_ElectricBike,
        .iconPic = gItemIcon_MachBike,
        .iconPalette = gItemIconPalette_MachBike,
    },

    [ITEM_BATERIA_DE_BICICLETA] =
    {
        .name = ITEM_NAME("Batería bici"),
        .price = 300,
        .description = COMPOUND_STRING(
            "Una batería que\n"
            "alimenta la Bicicleta\n"
            "Eléctrica (100 pasos)."),
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_FIELD_USE,
        .type = ITEM_USE_BAG_MENU,
