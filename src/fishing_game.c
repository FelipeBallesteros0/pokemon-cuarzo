...
static void CreateMinigameSprites(u8 taskId)
{
    ...
    u8 iconPalSlot;
    LoadMonIconPalettePersonality(species, GetMonData(&gEnemyParty[0], MON_DATA_PERSONALITY));
    iconPalSlot = GetValidMonIconPalIndex(species);
