...
#define tFollowerEnabled data[7]

#define OPTION_ROW_HEIGHT 14
#define OPTION_MENU_TOP_Y 40
...
#define YPOS_FOLLOWER     (MENUITEM_FOLLOWER * OPTION_ROW_HEIGHT)
...
static const u8 gText_TextSpeedSlow[]      = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}LENTA");
static const u8 gText_TextSpeedMid[]       = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MEDIA");
static const u8 gText_TextSpeedFast[]      = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}RAPIDA");
static const u8 gText_BattleSceneOn[]      = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SI");
static const u8 gText_BattleSceneOff[]     = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NO");
static const u8 gText_BattleStyleShift[]   = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}CAMBIO");
static const u8 gText_BattleStyleSet[]     = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FIJO");
static const u8 gText_SoundMono[]          = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MONO");
static const u8 gText_SoundStereo[]        = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ESTEREO");
...
static const u8 gText_FollowerOn[]         = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SI");
static const u8 gText_FollowerOff[]        = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NO");
...
{
    [MENUITEM_TEXTSPEED]   = COMPOUND_STRING("VEL. TEXTO"),
    [MENUITEM_BATTLESCENE] = COMPOUND_STRING("ESCENA COMB."),
    [MENUITEM_BATTLESTYLE] = COMPOUND_STRING("ESTILO COMB."),
    [MENUITEM_SOUND]       = COMPOUND_STRING("SONIDO"),
    [MENUITEM_BUTTONMODE]  = COMPOUND_STRING("MODO BOTON"),
    [MENUITEM_FOLLOWER]    = COMPOUND_STRING("POKéMON SEGUIDOR"),
    [MENUITEM_FRAMETYPE]   = COMPOUND_STRING("MARCO"),
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tFollowerEnabled = FlagGet(B_FLAG_FOLLOWERS_DISABLED) ? 1 : 0;
        ...
        Follower_DrawChoices(gTasks[taskId].tFollowerEnabled);
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_FOLLOWER:
            previousOption = gTasks[taskId].tFollowerEnabled;
            gTasks[taskId].tFollowerEnabled = Follower_ProcessInput(gTasks[taskId].tFollowerEnabled);

            if (previousOption != gTasks[taskId].tFollowerEnabled)
                Follower_DrawChoices(gTasks[taskId].tFollowerEnabled);
            break;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    if (gTasks[taskId].tFollowerEnabled)
...
static void HighlightOptionMenuItem(u8 index)
{
    ...
    SetGpuReg(REG_OFFSET_WIN0V, WIN_RANGE(OPTION_MENU_TOP_Y + index * OPTION_ROW_HEIGHT,
                                          OPTION_MENU_TOP_Y + index * OPTION_ROW_HEIGHT + OPTION_ROW_HEIGHT));
}
