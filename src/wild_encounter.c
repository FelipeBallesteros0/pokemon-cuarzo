...
bool8 UpdateRepelCounter(void)
{
    ...
    if (gSaveBlock1Ptr->rechargeableRepelSteps != 0)
    {
        gSaveBlock1Ptr->rechargeableRepelSteps--;
        if (gSaveBlock1Ptr->rechargeableRepelSteps == 0 && steps == 0)
        {
...
static bool8 IsWildLevelAllowedByRepel(u8 wildLevel)
{
    ...
    if (gSaveBlock1Ptr->rechargeableRepelSteps == 0 && !REPEL_STEP_COUNT)
        return TRUE;
