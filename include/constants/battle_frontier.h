...
#define FLAG_FRONTIER_MON_FACTORY_FORMS_ON  (1 << 1)
#define FLAG_FRONTIER_MON_FACTORY_FORMS_OFF (1 << 2)

#define FACTORY_MONID_MASK 0x3FFF
#define FACTORY_MONFLAG_FORMS_ON 0x8000
#define FACTORY_MONFLAG_FORMS_OFF 0x4000
#define FACTORY_MONFLAGS_MASK (FACTORY_MONFLAG_FORMS_ON | FACTORY_MONFLAG_FORMS_OFF)
